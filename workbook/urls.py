...
urlpatterns = [
    ...
    url(r'^solicitacoes/all', ListSolicitacoesPendentes.as_view()),
    url(r'^solicitacoes/minhas_solicitacoes', ListSolicitacoes.as_view()),
    ...
    url(r'^servicos/solicitacoes/(\d+)/orcamento$', GetOrcamentoPorSolicitacao.as_view()),
    ...
    url(r'^mensagens/count/', CountMensagens.as_view()),
